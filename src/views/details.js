import { deleteBook, getBookById, getLikesCountByBookId, getMyLikesByBookId, likeBook } from '../api/data.js';
...
export async function detailsPage(ctx) {
    ...
    const [book, likes, hasLiked] = await Promise.all([
        ...
        getLikesCountByBookId(ctx.params.id),
    ...
    async function onDelete() {
        const choice = confirm(`Are you sure, you want to delete the ${book.title}?`);
        if (choice) {
